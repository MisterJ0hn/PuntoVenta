<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MensajeFinProceso.aspx.cs" Inherits="Presentacion.MensajeFinProceso" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    &nbsp;&nbsp;<img alt="sati" class="style3" longdesc="sati" 
                        src="Imagenes/Satisfactorio.jpg" /></td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style4">
                    ...
                    Recuerde imprimir informe de producción y listados de control</span></td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                        style="text-align: center" Text="Aceptar" Width="120px" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
