...
namespace InventarioWeb.bodega
{
    public partial class IngresoDocumento : System.Web.UI.Page 
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if(appDocumentos.AgregarDocumento(Convert.ToInt32(txtNumero.Text), Convert.ToInt32(txtMonto.Text), txtFechaVenc.Text, txtRutEmpresa.Text, Session["rutEmpresa"].ToString(),Convert.ToInt32(Session["idUsuario"].ToString())))
            {
