<%@ Page Title="" Language="C#" MasterPageFile="~/ADM.Master" AutoEventWireup="true" CodeBehind="GestionDocumentos.aspx.cs" Inherits="InventarioWeb.admin.GestionDocumentos" %>
...
<asp:Button ID="btnProductos" runat="server" Text="Ingresar Productos" onclick="btnProductos_Click" 
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FechaemisionDocumento" 
                ...
                SortExpression="FechaemisionDocumento" />
            ...
            <asp:ButtonField ButtonType="Button" CommandName="Editar" Text="Ver" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT DOCUMENTO.IdDocumento, EMPRESA.NombreEmpresa, EMPRESA.RutEmpresa, DOCUMENTO.NumeroDocumento, DOCUMENTO.FechaemisionDocumento, 
