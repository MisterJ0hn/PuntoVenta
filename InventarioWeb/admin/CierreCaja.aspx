    ...
    <tr>
        <td align="center" class="style9" valign="top">
            <div style="border: thin solid #000000">
                ...
                <asp:TextBox ID="txtCantidadCredito" runat="server" Width="70" ></asp:TextBox><br />
            ...
            <asp:Panel DefaultButton="btnMenor" runat="server" >
                ...
                <asp:TextBox ID="txtCantidadMenor" runat="server" Width="70"></asp:TextBox><br />
        ...
        <td align="center" class="style10" valign="top">
            ...
            <asp:Panel ID="pnlcredito" runat="server" DefaultButton="btnAgregarEgreso">
                ...
                <div style="text-align:left">
                    ...
                    <asp:TextBox ID="txtCantidad" runat="server" Width="70"></asp:TextBox><br />
        ...
        <td align="center" class="style11" valign="top">
            ...
            <div style="border: thin solid #000000">
                <h1>Resumen</h1>
                <asp:Label ID="lbl1" Text="Cr&eacute;ditos" runat="server" Width="100"></asp:Label><asp:TextBox ID="lblCreditos" runat="server" Enabled="false">0</asp:TextBox><br />
                <asp:Label ID="label8" Text="Egresos" runat="server" Width="100" ></asp:Label><asp:TextBox ID="lblEgresos" runat="server" Enabled="false">0</asp:TextBox><br />
                <asp:Label ID="Label5" Text="Devoluci&oacute;n" runat="server" Width="100" ></asp:Label>
                <asp:TextBox ID="lblDevolucionResumen" runat="server" AutoPostBack="true" 
                    Text="0" ontextchanged="lblDevolucionResumen_TextChanged"></asp:TextBox><br />
                <asp:Label ID="Label13" Text="Venta Menor" runat="server" Width="100" ></asp:Label><asp:TextBox ID="txtMenor" runat="server" Enabled="false">0</asp:TextBox><br />
                
                <br />
                <asp:Label ID="Label7" Text="Total" runat="server" Width="100" ></asp:Label><asp:TextBox ID="lblTotalResumen" runat="server" Enabled="false">0</asp:TextBox>
                 <br />
            <br />
            </div>
            ...
            <div style="border: thin solid #000000">
                <h1>Cuadratura</h1>
                <asp:Label ID="lblCuad1" text="Sistema" runat="server" Width="100"></asp:Label><asp:TextBox ID="lblComputador" runat="server" Enabled="false">0</asp:TextBox><br />
                <asp:Label ID="lblCuad2" Text="Caja" runat="server" Width="100"></asp:Label><asp:TextBox ID="lblIngesos" runat="server" Enabled="false">0</asp:TextBox><br />
                <asp:Label ID="lblcuad3" Text="Diferencia" runat="server" Width="100"></asp:Label><asp:TextBox ID="lblDiferencia" runat="server" Enabled="false">0</asp:TextBox>
            <br />
            <br />
            </div>
