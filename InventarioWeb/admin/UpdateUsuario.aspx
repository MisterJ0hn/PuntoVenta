<%@ Page Title="" Language="C#" MasterPageFile="~/ADM.Master" AutoEventWireup="true" CodeBehind="UpdateUsuario.aspx.cs" Inherits="InventarioWeb.admin.UpdateUsuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


<h1><asp:Label ID="Label1" Text="Detalle de Usuario" runat="server"></asp:Label></h1>
...
<asp:CustomValidator ID="vldUsuario2" runat="server" OnServerValidate="ValidarUsuario" ControlToValidate="txtUsuario" ErrorMessage="El usuario ya existe"></asp:CustomValidator>
</p>
<p>
...
<asp:Button runat="server" Text="Modificar" Width="70px"  ID="btnModificar" 
